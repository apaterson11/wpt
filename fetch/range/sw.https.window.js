...
promise_test(async t => {
  ...
  assert_true(counts_valid, `Opaque range errors and success preloads should result in the same number of fetches`);
}, `Opaque range preload successes and failures treated similarly`);
